...
testimonial_photos = Photo.create([
  { status: "active", image: File.new("public/shared_photos/feedback/feedback-bg.jpg"), is_cover_photo: false, user_id: 1, imageable_type: "Testimonial", imageable_id: testimonials.first.id },
  { status: "active", image: File.new("public/shared_photos/feedback/feedback-thumb.jpg"), is_cover_photo: false, user_id: 1, imageable_type: "Testimonial", imageable_id: testimonials.second.id }
])